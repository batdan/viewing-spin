...
$minifySpin = "minifySpin('" . $_GET['spinid'] . "', '" . $lastmodif . "');";
?>
<style type="text/css">
    #apercu {
        color: #444;
...
<div id="apercu">
    <em>Minifier le contenu du masterspin <span class="champ">"<?php echo $chp; ?>"</span></em>

    <div id="buttons">
        <button type="button" class="btn btn-default btn-sm" onclick="$.fancybox.close();">Annuler</button>
        <button type="button" class="btn btn-primary btn-sm" onclick="<?php echo $minifySpin ?>">Valider</button>
    </div>
</div>
